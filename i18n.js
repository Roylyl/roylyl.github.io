(() => {
  ...
  const tw = {
    ...
    '查看项目': '查看專案', '联系我': '聯絡我', '硬件 / 嵌入式': '硬體 / 嵌入式', '音乐 QA': '音樂 QA', '简体 · 繁體 · English': '簡體 · 繁體 · English',
    ...
    '把工程判断放进真实行业场景。': '把工程判斷放進真實行業場景。', '湖南康通电子股份有限公司': '湖南康通電子股份有限公司',
    '硬件与市场调研': '硬件與市場調研', '2026.08 — 至今': '2026.08 — 至今',
    ...
    'Android 控制基线': 'Android 控制基線', '当前工程基线由 Android 端通过 BLE 完成设备发现、控制与状态展示；BLE 不承载 PCM 音频。': '目前工程基線由 Android 端透過 BLE 完成裝置發現、控制與狀態展示；BLE 不承載 PCM 音頻。',
  ...
  const en = {
    ...
    '把工程判断放进真实行业场景。': 'Applying engineering judgment in a real industry context.', '湖南康通电子股份有限公司': 'Hunan Comtom Electronic Co., Ltd.',
    '硬件与市场调研': 'Hardware & market research', '2026.08 — 至今': 'Aug 2026 — Present',
    ...
    'Android 控制基线': 'Android control baseline', '当前工程基线由 Android 端通过 BLE 完成设备发现、控制与状态展示；BLE 不承载 PCM 音频。': 'In the current engineering baseline, Android uses BLE for device discovery, control, and status display; BLE does not carry PCM audio.',
