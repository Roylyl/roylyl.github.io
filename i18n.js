(() => {
  ...
  const cn = {
    ...
    'MUSIC · SECONDARY': '音乐 · 第二主线', 'SOCIAL': '社交媒体', 'WECHAT': '微信', 'DOUYIN': '抖音', 'WHATSAPP': 'WHATSAPP', 'CONTACT': '联系方式',
  ...
  const tw = {
    ...
    'MUSIC · SECONDARY': '音樂 · 第二主線', 'SOCIAL': '社群媒體', 'WECHAT': '微信', 'DOUYIN': '抖音', 'WHATSAPP': 'WHATSAPP', 'CONTACT': '聯絡方式', 'Embedded': '嵌入式', 'Hardware': '硬體', 'Project Delivery': '專案交付', 'Audio Awareness': '音訊感知',
    ...
    '微信': '微信', '扫码添加好友，适合项目交流与日常联系。': '掃描 QR Code 添加好友，適合專案交流與日常聯絡。',
  ...
  const en = {
    ...
    '更多联系方式与社交媒体。': 'More ways to connect.', '微信': 'WeChat', '扫码添加好友，适合项目交流与日常联系。': 'Scan the QR code to add me for project discussions or everyday contact.', '抖音': 'Douyin', '@Roylyl · 抖音号：luoyulun': '@Roylyl · Douyin ID: luoyulun', 'WHATSAPP': 'WHATSAPP', '扫码添加 WhatsApp，方便跨地区联系。': 'Scan to add me on WhatsApp.',
