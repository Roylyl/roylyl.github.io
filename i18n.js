(() => {
  ...
  const cn = {
    ...
    'CURRENT EXPERIENCE': '当前经历', 'HARDWARE & MARKET RESEARCH': '硬件与市场调研', 'FIRST PCB VALIDATED': '首版 PCB 已验证',
  ...
  const tw = {
    ...
    'CURRENT EXPERIENCE': '目前經歷', 'HARDWARE & MARKET RESEARCH': '硬件與市場調研', 'FIRST PCB VALIDATED': '首版 PCB 已驗證',
