(() => {
  ...
  const cn = {
    ...
    'MUSIC · SECONDARY': '音乐 · 第二主线', 'SOCIAL': '社交媒体', 'WECHAT': '微信', 'DOUYIN': '抖音', 'CONTACT': '联系方式',
  ...
  const tw = {
    ...
    'MUSIC · SECONDARY': '音樂 · 第二主線', 'SOCIAL': '社群媒體', 'WECHAT': '微信', 'DOUYIN': '抖音', 'CONTACT': '聯絡方式', 'Embedded': '嵌入式', 'Hardware': '硬體', 'Project Delivery': '專案交付', 'Audio Awareness': '音訊感知',
